 ...
 */
export declare const verifyCashAssemblyEvaluationState: <ProgramState extends AuthenticationProgramStateControlStack<boolean> & AuthenticationProgramStateError & AuthenticationProgramStateStack<Uint8Array>>(state: ProgramState) => string | true;
/**
 ...
 */
export declare const reduceScript: <ProgramState extends AuthenticationProgramStateControlStack<boolean> & AuthenticationProgramStateError & AuthenticationProgramStateStack<Uint8Array>, AuthenticationProgram, ResolvedTransaction>(resolvedScript: ResolvedScript, vm?: AuthenticationVirtualMachine<ResolvedTransaction, AuthenticationProgram, ProgramState> | undefined, createEvaluationProgram?: ((instructions: Uint8Array) => AuthenticationProgram) | undefined) => ScriptReductionTraceScriptNode<ProgramState>;
