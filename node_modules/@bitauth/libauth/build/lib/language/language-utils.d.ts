 ...
 */
export declare const extractBytecodeResolutions: (resolvedScript: ResolvedScript) => CashAssemblyResolution[];
/**
 ...
 * evaluation step.
 */
export declare const summarizeDebugTrace: <Trace extends (AuthenticationProgramStateAlternateStack<Uint8Array> & AuthenticationProgramStateControlStack<unknown> & AuthenticationProgramStateError & AuthenticationProgramStateMinimum & AuthenticationProgramStateStack<Uint8Array>)[]>(trace: Trace) => {
