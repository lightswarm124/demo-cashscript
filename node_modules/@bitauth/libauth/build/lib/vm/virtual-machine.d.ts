 ...
 */
export interface InstructionSet<ResolvedTransaction, AuthenticationProgram, ProgramState> {
    /**
 ...
 */
export interface AuthenticationVirtualMachine<ResolvedTransaction, AuthenticationProgram, ProgramState> {
    /**
