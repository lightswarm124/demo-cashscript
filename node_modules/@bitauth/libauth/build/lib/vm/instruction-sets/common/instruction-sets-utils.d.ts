 ...
 */
export declare const cloneAuthenticationInstruction: (instruction: Readonly<AuthenticationInstruction>) => AuthenticationInstruction;
/**
 ...
 * disassemble
 */
export declare const disassembleAuthenticationInstructionMalformed: (opcodes: Readonly<{
 ...
 */
export declare const disassembleAuthenticationInstruction: (opcodes: Readonly<{
    [opcode: number]: string;
 ...
 * @param instruction - the instruction to disassemble
 */
export declare const disassembleAuthenticationInstructionMaybeMalformed: (opcodes: Readonly<{
    [opcode: number]: string;
 ...
 */
export declare const disassembleAuthenticationInstructionsMaybeMalformed: (opcodes: Readonly<{
    [opcode: number]: string;
}>, instructions: readonly AuthenticationInstructionMaybeMalformed[]) => string;
/**
 ...
 */
export declare const disassembleBytecode: (opcodes: Readonly<{
    [opcode: number]: string;
 ...
 */
export declare const encodeAuthenticationInstructions: (instructions: readonly AuthenticationInstruction[]) => Uint8Array;
/**
 ...
 */
export declare const encodeAuthenticationInstructionsMaybeMalformed: (instructions: readonly AuthenticationInstructionMaybeMalformed[]) => Uint8Array;
