...
export declare const pushOperation: <State extends AuthenticationProgramStateControlStack<boolean> & AuthenticationProgramStateError & AuthenticationProgramStateMinimum & AuthenticationProgramStateStack<Uint8Array>>(maximumPushSize?: ConsensusCommon) => Operation<State>;
/**
 ...
 */
export declare const pushNumberOperation: <ProgramState extends AuthenticationProgramStateMinimum & AuthenticationProgramStateStack<Uint8Array>>(number: number) => (state: ProgramState) => ProgramState;
