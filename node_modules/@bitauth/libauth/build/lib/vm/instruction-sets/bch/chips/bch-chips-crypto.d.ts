...
export declare const opRipemd160ChipLimits: <State extends AuthenticationProgramStateError & AuthenticationProgramStateMinimum & AuthenticationProgramStateResourceLimitsBCHCHIPs & AuthenticationProgramStateStack<Uint8Array>>({ ripemd160, }?: {
    ripemd160: {
        hash: Ripemd160['hash'];
    };
}) => Operation<State>;
export declare const opSha1ChipLimits: <State extends AuthenticationProgramStateError & AuthenticationProgramStateMinimum & AuthenticationProgramStateResourceLimitsBCHCHIPs & AuthenticationProgramStateStack<Uint8Array>>({ sha1, }?: {
    sha1: {
        hash: Sha1['hash'];
    };
}) => Operation<State>;
export declare const opSha256ChipLimits: <State extends AuthenticationProgramStateError & AuthenticationProgramStateMinimum & AuthenticationProgramStateResourceLimitsBCHCHIPs & AuthenticationProgramStateStack<Uint8Array>>({ sha256, }?: {
    sha256: {
        hash: Sha256['hash'];
    };
}) => Operation<State>;
export declare const opHash160ChipLimits: <State extends AuthenticationProgramStateError & AuthenticationProgramStateMinimum & AuthenticationProgramStateResourceLimitsBCHCHIPs & AuthenticationProgramStateStack<Uint8Array>>({ ripemd160, sha256, }?: {
    sha256: {
        hash: Sha256['hash'];
    };
    ripemd160: {
...
export declare const opHash256ChipLimits: <State extends AuthenticationProgramStateError & AuthenticationProgramStateMinimum & AuthenticationProgramStateResourceLimitsBCHCHIPs & AuthenticationProgramStateStack<Uint8Array>>({ sha256, }?: {
    sha256: {
        hash: Sha256['hash'];
    };
}) => Operation<State>;
...
export declare const opCheckDataSigChipLimits: <State extends AuthenticationProgramStateError & AuthenticationProgramStateResourceLimitsBCHCHIPs & AuthenticationProgramStateSignatureAnalysis & AuthenticationProgramStateStack<Uint8Array>>({ secp256k1, sha256, }: {
    sha256: {
        hash: Sha256['hash'];
    };
    secp256k1: {
...
export declare const opCheckDataSigVerifyChipLimits: <State extends AuthenticationProgramStateError & AuthenticationProgramStateResourceLimitsBCHCHIPs & AuthenticationProgramStateSignatureAnalysis & AuthenticationProgramStateStack<Uint8Array>>({ secp256k1, sha256, }?: {
    sha256: {
        hash: Sha256['hash'];
    };
    secp256k1: {
