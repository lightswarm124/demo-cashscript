...
export declare const pushTokenExtendedCategory: <State extends AuthenticationProgramStateError & AuthenticationProgramStateStack<Uint8Array> & AuthenticationProgramStateTransactionContext>(state: State, utxo: Output) => State;
