...
export declare const pushOperationChipLoops: <State extends AuthenticationProgramStateControlStackCHIPs & AuthenticationProgramStateError & AuthenticationProgramStateMinimum & AuthenticationProgramStateStack<Uint8Array>>(maximumPushSize?: ConsensusCommon) => Operation<State>;
/**
...
export declare const opIfChipLoops: <State extends AuthenticationProgramStateControlStackCHIPs & AuthenticationProgramStateError & AuthenticationProgramStateStack<Uint8Array>>(state: State) => State;
export declare const opNotIfChipLoops: <State extends AuthenticationProgramStateControlStackCHIPs & AuthenticationProgramStateError & AuthenticationProgramStateStack<Uint8Array>>(state: State) => State;
