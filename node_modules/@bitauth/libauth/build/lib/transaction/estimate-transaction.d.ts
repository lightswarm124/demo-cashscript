 ...
 */
export declare const estimateTransaction: <CompilerType extends Compiler<unknown, AnyCompilerConfiguration<unknown>, unknown>>(template: Readonly<TransactionTemplateEstimated<CompilerType>>) => TransactionGenerationAttempt;
