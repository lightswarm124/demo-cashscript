...
export interface Secp256k1 {
     ...
     */
    readonly addTweakPrivateKey: (privateKey: Uint8Array, tweakValue: Uint8Array) => Uint8Array | string;
    /**
     ...
     * @param tweakValue - 256 bit value to tweak by (BE)
     */
    readonly addTweakPublicKeyCompressed: (publicKey: Uint8Array, tweakValue: Uint8Array) => Uint8Array | string;
    /**
     * Tweak a `publicKey` by adding `tweakValue` times the generator to it.
     *
     * Returns an error message if the provided public key could not be parsed or
     ...
     * @param tweakValue - 256 bit value to tweak by (BE)
     */
    readonly addTweakPublicKeyUncompressed: (publicKey: Uint8Array, tweakValue: Uint8Array) => Uint8Array | string;
    /**
     ...
     */
    readonly derivePublicKeyCompressed: (privateKey: Uint8Array) => Uint8Array | string;
    /**
     ...
     * @param privateKey - a valid secp256k1, 32-byte private key
     */
    readonly derivePublicKeyUncompressed: (privateKey: Uint8Array) => Uint8Array | string;
    /**
     ...
     * bytes
     */
    readonly malleateSignatureCompact: (signature: Uint8Array) => Uint8Array | string;
    /**
     ...
     *
     */
    readonly mulTweakPrivateKey: (privateKey: Uint8Array, tweakValue: Uint8Array) => Uint8Array | string;
    /**
     ...
     * @param tweakValue - 256 bit value to tweak by (BE)
     */
    readonly mulTweakPublicKeyCompressed: (publicKey: Uint8Array, tweakValue: Uint8Array) => Uint8Array | string;
    /**
     * Tweak a `publicKey` by multiplying `tweakValue` to it.
     *
     * Returns an error message if the provided public key could not be parsed or
     ...
     * @param tweakValue - 256 bit value to tweak by (BE)
     */
    readonly mulTweakPublicKeyUncompressed: (publicKey: Uint8Array, tweakValue: Uint8Array) => Uint8Array | string;
    /**
     ...
     */
    readonly normalizeSignatureCompact: (signature: Uint8Array) => Uint8Array | string;
    /**
     ...
     * form, max 72 bytes
     */
    readonly normalizeSignatureDER: (signature: Uint8Array) => Uint8Array | string;
    /**
     ...
     * number
     */
    readonly recoverPublicKeyCompressed: (signature: Uint8Array, recoveryId: RecoveryId, messageHash: Uint8Array) => Uint8Array | string;
    /**
     ...
     * number
     */
    readonly recoverPublicKeyUncompressed: (signature: Uint8Array, recoveryId: RecoveryId, messageHash: Uint8Array) => Uint8Array | string;
    /**
     ...
     */
    readonly signatureCompactToDER: (signature: Uint8Array) => Uint8Array | string;
    /**
     ...
     */
    readonly signatureDERToCompact: (signature: Uint8Array) => Uint8Array | string;
    /**
     ...
     */
    readonly signMessageHashCompact: (privateKey: Uint8Array, messageHash: Uint8Array) => Uint8Array | string;
    /**
     ...
     * @param messageHash - the 32-byte message hash to be signed
     */
    readonly signMessageHashDER: (privateKey: Uint8Array, messageHash: Uint8Array) => Uint8Array | string;
    /**
     * Create an ECDSA signature in compact format. The created signature is
     * always in lower-S form and follows RFC 6979.
     *
     ...
     * @param messageHash - the 32-byte message hash to be signed
     */
    readonly signMessageHashRecoverableCompact: (privateKey: Uint8Array, messageHash: Uint8Array) => RecoverableSignature | string;
    /**
     ...
     * @param messageHash - the 32-byte message hash to be signed
     */
    readonly signMessageHashSchnorr: (privateKey: Uint8Array, messageHash: Uint8Array) => Uint8Array | string;
    /**
