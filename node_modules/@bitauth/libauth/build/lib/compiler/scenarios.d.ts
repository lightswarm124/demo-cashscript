import type { AnyCompilerConfigurationIgnoreOperations, AuthenticationTemplateScenario, AuthenticationTemplateScenarioBytecode, AuthenticationTemplateScenarioData, AuthenticationTemplateScenarioOutput, CompilationContextBCH, CompilationData, CompilationResult, Output, Scenario, ScenarioGenerationDebuggingResult } from '../lib.js';
/**
 * The contents of an {@link AuthenticationTemplateScenario} without the `name`
 * and `description`.
 */
export type ScenarioDefinition = Pick<AuthenticationTemplateScenario, 'data' | 'sourceOutputs' | 'transaction'>;
 ...
 * scenario
 */
export declare const extendScenarioDefinition: <ParentScenarioType extends AuthenticationTemplateScenario>(parentScenario: ParentScenarioType, childScenario: AuthenticationTemplateScenario) => ParentScenarioType extends ExtendedScenarioDefinition ? ExtendedScenarioDefinition : ScenarioDefinition;
/**
 ...
 */
export declare const compileAuthenticationTemplateScenarioValueSatoshis: (valueSatoshisDefinition?: AuthenticationTemplateScenarioOutput<boolean>['valueSatoshis']) => bigint;
/**
 ...
 */
export declare const compileAuthenticationTemplateScenarioBytecode: <Configuration extends AnyCompilerConfigurationIgnoreOperations<CompilationContextBCH>, GenerateBytecode extends <Debug extends boolean>({ data, debug, scriptId, }: {
 ...
 */
export declare const compileScenarioOutputTokenData: (output: AuthenticationTemplateScenarioOutput<boolean>) => Pick<Output, 'token'>;
/**
 ...
 */
export declare const generateScenarioBCH: <Configuration extends AnyCompilerConfigurationIgnoreOperations<CompilationContextBCH>, GenerateBytecode extends <Debug extends boolean>({ data, debug, scriptId, }: {
    data: CompilationData<CompilationContextBCH>;
    debug?: Debug | undefined;
    scriptId: string;
