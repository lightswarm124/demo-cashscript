import type { AnyCompilerConfiguration, AuthenticationTemplate, CompilationContextBCH, CompilationData, CompilerConfiguration, CompilerOperationResult, Sha256 } from '../../lib.js';
 ...
 */
export declare const createCompilerBCH: <Configuration extends AnyCompilerConfiguration<CompilationContextBCH>, ProgramState extends import("../../lib.js").AuthenticationProgramStateCommon>(configuration: Configuration) => import("../compiler-types.js").Compiler<CompilationContextBCH, Configuration, ProgramState>;
export declare const createCompiler: <Configuration extends AnyCompilerConfiguration<CompilationContextBCH>, ProgramState extends import("../../lib.js").AuthenticationProgramStateCommon>(configuration: Configuration) => import("../compiler-types.js").Compiler<CompilationContextBCH, Configuration, ProgramState>;
/**
