import type { AuthenticationProgramCommon, AuthenticationTemplateScenario, AuthenticationTemplateVariable, AuthenticationVirtualMachine, CompilationContextBCH, CompilationResult, CompilationResultError, Ripemd160, Secp256k1, Sha256, Sha512 } from '../lib.js';
 ...
 * the compiler
 */
export type CompilerOperation<CompilationContext = unknown, CanBeSkipped extends boolean = false, Data extends CompilationData<CompilationContext> = CompilationData<CompilationContext>, Configuration extends AnyCompilerConfiguration<CompilationContext> = CompilerConfiguration<CompilationContext>> = (identifier: string, data: Data, configuration: Configuration) => CompilerOperationResult<CanBeSkipped>;
 ...
 */
export interface Compiler<CompilationContext, Configuration extends AnyCompilerConfiguration<CompilationContext>, ProgramState> {
