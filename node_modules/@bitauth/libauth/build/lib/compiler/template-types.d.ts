...
export interface AuthenticationTemplate {
     ...
     */
    scripts: {
        [scriptId: string]: AuthenticationTemplateScript | AuthenticationTemplateScriptLocking | AuthenticationTemplateScriptTested | AuthenticationTemplateScriptUnlocking;
    };
    /**
 ...
 */
export type AuthenticationTemplateScenarioBytecode = string | {
    /**
 ...
 */
export interface AuthenticationTemplateScenarioOutput<IsSourceOutput extends boolean> {
    /**
     ...
     */
    readonly lockingBytecode?: IsSourceOutput extends true ? AuthenticationTemplateScenarioBytecode | ['slot'] : AuthenticationTemplateScenarioBytecode;
    /**
 ...
 * transaction.
 */
export type AuthenticationTemplateScenarioTransactionOutput = AuthenticationTemplateScenarioOutput<false>;
/**
 * A source output used by an authentication template scenario.
 */
export type AuthenticationTemplateScenarioSourceOutput = AuthenticationTemplateScenarioOutput<true>;
/**
...
export type AuthenticationTemplateVariable = AuthenticationTemplateAddressData | AuthenticationTemplateHdKey | AuthenticationTemplateKey | AuthenticationTemplateWalletData;
