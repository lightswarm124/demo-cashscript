import type { AnyCompilerConfiguration, AuthenticationProgramCommon, AuthenticationProgramStateCommon, AuthenticationProgramStateControlStack, AuthenticationProgramStateMinimum, AuthenticationProgramStateStack, AuthenticationTemplate, BytecodeGenerationResult, CompilationContextBCH, CompilationData, CompilationResult, Compiler, CompilerConfiguration } from '../lib.js';
/**
 * Create a {@link Compiler.generateBytecode} method given a compiler
 * configuration.
 */
export declare const createCompilerGenerateBytecodeFunction: <CompilationContext extends CompilationContextBCH, Configuration extends AnyCompilerConfiguration<CompilationContext>, ProgramState extends AuthenticationProgramStateControlStack<boolean> & AuthenticationProgramStateMinimum & AuthenticationProgramStateStack<Uint8Array>>(compilerConfiguration: Configuration) => <Debug extends boolean>({ data, debug, scriptId, }: {
    scriptId: string;
 ...
 */
export declare const compilerConfigurationToCompilerBCH: <Configuration extends AnyCompilerConfiguration<CompilationContextBCH>, ProgramState extends AuthenticationProgramStateControlStack<boolean> & AuthenticationProgramStateMinimum & AuthenticationProgramStateStack<Uint8Array>>(configuration: Configuration) => Compiler<CompilationContextBCH, Configuration, ProgramState>;
 ...
 */
export declare const createCompilerCommon: <Configuration extends AnyCompilerConfiguration<CompilationContextBCH>, ProgramState extends AuthenticationProgramStateCommon>(scriptsAndOverrides: Configuration) => Compiler<CompilationContextBCH, Configuration, ProgramState>;
/**
 ...
 */
export declare const assembleBytecode: (opcodes: Readonly<{
    [opcode: string]: Uint8Array;
}>, disassembledBytecode: string) => import("../lib.js").CompilationResultParseError | import("../lib.js").CompilationResultResolveError | {
    bytecode: Uint8Array;
    success: true;
} | import("../lib.js").CompilationResultReduceError<AuthenticationProgramStateCommon> | import("../lib.js").CompilationResultSuccess<AuthenticationProgramStateCommon>;
/**
 ...
 */
export declare const assembleBytecodeBCH: (disassembledBytecode: string) => import("../lib.js").CompilationResultParseError | import("../lib.js").CompilationResultResolveError | {
    bytecode: Uint8Array;
    success: true;
} | import("../lib.js").CompilationResultReduceError<AuthenticationProgramStateCommon> | import("../lib.js").CompilationResultSuccess<AuthenticationProgramStateCommon>;
/**
 ...
 */
export declare const assembleBytecodeBTC: (disassembledBytecode: string) => import("../lib.js").CompilationResultParseError | import("../lib.js").CompilationResultResolveError | {
    bytecode: Uint8Array;
    success: true;
} | import("../lib.js").CompilationResultReduceError<AuthenticationProgramStateCommon> | import("../lib.js").CompilationResultSuccess<AuthenticationProgramStateCommon>;
/**
 ...
 */
export declare const authenticationTemplateToCompilerConfiguration: (template: AuthenticationTemplate) => Pick<CompilerConfiguration, 'entityOwnership' | 'lockingScriptTypes' | 'scenarios' | 'scripts' | 'unlockingScripts' | 'unlockingScriptTimeLockTypes' | 'variables'>;
