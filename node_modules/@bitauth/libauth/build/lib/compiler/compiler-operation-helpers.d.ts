import type { AnyCompilerConfiguration, AuthenticationTemplateHdKey, CompilationContextBCH, CompilationData, CompilerConfiguration, CompilerOperation, CompilerOperationErrorFatal, CompilerOperationResult } from '../lib.js';
/**
 ...
 */
export declare const attemptCompilerOperations: <CompilationContext = CompilationContextBCH>(operations: CompilerOperation<CompilationContext, true, CompilationData<CompilationContext>, CompilerConfiguration<CompilationContext, import("./compiler-types.js").CompilerOperationsKeysCommon, import("./compiler-types.js").CompilerOperationsSigningSerializationCommon, false, false, false, false>>[], finalOperation: CompilerOperation<CompilationContext, false, CompilationData<CompilationContext>, CompilerConfiguration<CompilationContext, import("./compiler-types.js").CompilerOperationsKeysCommon, import("./compiler-types.js").CompilerOperationsSigningSerializationCommon, false, false, false, false>>) => CompilerOperation<CompilationContext, false, CompilationData<CompilationContext>, CompilerConfiguration<CompilationContext, import("./compiler-types.js").CompilerOperationsKeysCommon, import("./compiler-types.js").CompilerOperationsSigningSerializationCommon, false, false, false, false>>;
/**
 ...
 */
export declare const compilerOperationRequires: <CanBeSkipped extends boolean, RequiredDataProperties extends keyof CompilationData<unknown>, RequiredConfigurationProperties extends keyof CompilerConfiguration<unknown, import("./compiler-types.js").CompilerOperationsKeysCommon, import("./compiler-types.js").CompilerOperationsSigningSerializationCommon, false, false, false, false>, CompilationContext = CompilationContextBCH>({ canBeSkipped, dataProperties, configurationProperties, operation, }: {
    canBeSkipped: CanBeSkipped;
    dataProperties: RequiredDataProperties[];
    configurationProperties: RequiredConfigurationProperties[];
    operation: (identifier: string, data: CompilationData<CompilationContext> & Required<Pick<CompilationData<CompilationContext>, RequiredDataProperties>>, configuration: CompilerConfiguration<CompilationContext, import("./compiler-types.js").CompilerOperationsKeysCommon, import("./compiler-types.js").CompilerOperationsSigningSerializationCommon, false, false, false, false> & Required<Pick<CompilerConfiguration<CompilationContext, import("./compiler-types.js").CompilerOperationsKeysCommon, import("./compiler-types.js").CompilerOperationsSigningSerializationCommon, false, false, false, false>, RequiredConfigurationProperties>>) => CompilerOperationResult<CanBeSkipped>;
}) => CompilerOperation<CompilationContext, CanBeSkipped, CompilationData<CompilationContext>, CompilerConfiguration<CompilationContext, import("./compiler-types.js").CompilerOperationsKeysCommon, import("./compiler-types.js").CompilerOperationsSigningSerializationCommon, false, false, false, false>>;
export declare const compilerOperationAttemptBytecodeResolution: CompilerOperation<CompilationContextBCH, true, CompilationData<CompilationContextBCH>, CompilerConfiguration<CompilationContextBCH, import("./compiler-types.js").CompilerOperationsKeysCommon, import("./compiler-types.js").CompilerOperationsSigningSerializationCommon, false, false, false, false>>;
