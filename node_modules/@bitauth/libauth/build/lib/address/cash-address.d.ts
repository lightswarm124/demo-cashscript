...
export declare const decodeCashAddressVersionByte: (version: number) => CashAddressVersionByteDecodingError.reservedBitSet | {
    length: 64 | 32 | 20 | 24 | 28 | 40 | 48 | 56;
    typeBits: number;
};
/**
 ...
 */
export declare const encodeCashAddressFormat: (prefix: string, version: number, payload: Immutable<Uint8Array>) => string;
...
export declare const isValidCashAddressPayloadLength: (length: number) => length is 64 | 32 | 20 | 24 | 28 | 40 | 48 | 56;
/**
