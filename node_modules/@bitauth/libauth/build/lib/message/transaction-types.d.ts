 ...
 */
export interface Input<Bytecode = Uint8Array, ByteStringRepresentation = Uint8Array> {
    /**
 ...
 * default `Uint8Array`.
 */
export interface Output<Bytecode = Uint8Array, ByteStringRepresentation = Uint8Array> {
    /**
...
export type TransactionGenerationAttempt = TransactionGenerationError | TransactionGenerationSuccess;
