 ...
 */
export declare const encodeTransactionInputs: (inputs: readonly Input[]) => Uint8Array;
/**
 ...
 */
export declare const encodeTransactionOutputs: (outputs: readonly Output[]) => Uint8Array;
/**
...
export declare const cloneTransactionInputsCommon: <Transaction extends TransactionCommon<Input<Uint8Array, Uint8Array>, Output<Uint8Array, Uint8Array>>>(inputs: Readonly<Transaction>["inputs"]) => {
    outpointIndex: number;
    outpointTransactionHash: Uint8Array;
    sequenceNumber: number;
    unlockingBytecode: Uint8Array;
}[];
export declare const cloneTransactionOutputsCommon: <Transaction extends TransactionCommon<Input<Uint8Array, Uint8Array>, Output<Uint8Array, Uint8Array>>>(outputs: Readonly<Transaction>["outputs"]) => {
...
export declare const cloneTransactionCommon: <Transaction extends TransactionCommon<Input<Uint8Array, Uint8Array>, Output<Uint8Array, Uint8Array>>>(transaction: Readonly<Transaction>) => {
    inputs: {
        outpointIndex: number;
        outpointTransactionHash: Uint8Array;
        sequenceNumber: number;
 ...
 */
export declare const encodeTransactionOutpoints: (inputs: readonly {
    outpointIndex: number;
    outpointTransactionHash: Uint8Array;
}[]) => Uint8Array;
/**
 ...
 */
export declare const encodeTransactionOutputsForSigning: (outputs: readonly Output[]) => Uint8Array;
/**
 ...
 * numbers
 */
export declare const encodeTransactionInputSequenceNumbersForSigning: (inputs: readonly {
    sequenceNumber: number;
}[]) => Uint8Array;
