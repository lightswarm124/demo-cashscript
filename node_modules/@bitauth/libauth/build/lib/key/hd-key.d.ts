 ...
 */
export interface HdKeyParameters<NodeType extends HdPrivateNodeValid | HdPublicNode> {
    node: NodeType;
...
}) => AssumedValidity extends true ? HdPrivateNodeValid : AssumedValidity extends false ? HdPrivateNodeInvalid : HdPrivateNode;
/**
