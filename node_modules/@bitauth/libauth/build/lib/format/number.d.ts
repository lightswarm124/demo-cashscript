 ...
 */
export declare const compactSizePrefixToSize: (firstByte: number) => number;
export declare enum CompactSizeError {
 ...
 * `CompactSize`
 */
export declare const readCompactSize: (position: ReadPosition) => MaybeReadResult<bigint>;
/**
 ...
 */
export declare const bigIntToCompactSize: (value: bigint) => Uint8Array;
/**
 ...
 * `CompactSize`
 */
export declare const readCompactSizeMinimal: (position: ReadPosition) => MaybeReadResult<bigint>;
/**
 ...
 */
export declare const compactSizeToBigInt: (bin: Uint8Array) => string | bigint;
/**
