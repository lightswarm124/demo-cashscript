...
export type ImmutablePrimitive = Function | boolean | number | string | null | undefined;
 ...
 */
export type Immutable<T> = T extends ImmutablePrimitive ? T : T extends (infer U)[] ? ImmutableArray<U> : T extends Uint8Array ? ImmutableUint8Array : T extends Map<infer K, infer V> ? ImmutableMap<K, V> : T extends Set<infer M> ? ImmutableSet<M> : ImmutableObject<T>;
